#Premier exemple de comparaison entre GaussSuppression et tau-Argus sur 
#un tableau simple sans talbeaux liés et sans hierachies
...
#Comparraison entre les masques de tau-argus et GaussSuppression
masq_gauss %>% 
  ...
  filter(diff_status)
#ici on remarque que il n'y a pas de différence entre le masque de GaussSUppression
#et le masque de tau-argus ce qui est encourageant pour GaussSUppression 
